...
const DEFAULT_CATEGORIES: CategoryData = {
  'INCOME': {
    'REVENUE': ['SALES', 'WAGES', 'FEE INCOME', 'OTHER INCOME']
  },
  'EXPENSES': {
    'SALES COST': ['PURCHASE FOR SALES', 'WAGES EXPENSE', 'PAYROLL TAXES'],
    'HOUSING': ['RENT OR MORTGAGE'],
    'AUTO': ['AUTO PAYMENT', 'GAS EXPENSE', 'AUTO REPAIR', 'AUTO INSURANCE', 'AUTO OTHER EXPS', 'TRAPIC EXPENSE'],
    'FOOD': ['FOOD MATERIAL', 'MEAL', 'FOOD OTHER EXPS'],
    'CULTURAL': ['TELEPHONE', 'INTERNET', 'EDUCATION', 'TRAINING', 'ENTERTAINMENT'],
    'CLOTHING': ['CLOTH PURCHASE', 'ACCESSORY PURCHASE', 'CLOTH OTHERS'],
    'UTILITY': ['ELECTRIC POWER', 'GAS EXPENSE', 'WATER EXPENSE', 'UTILITY OTHER'],
    'INSURANCE': ['LIFE INSURANCE', 'BUS INSURANCE', 'MEDICAL INSURANCE', 'OTHER INSURANCE'],
    'MAINTENANCE': ['SUPPLIES', 'REPAIR', 'MAINT. OTHERS'],
    'OTHER': ['OTHER EXPENSE'],
    'TAX': ['TAX', 'OTHER TAXES']
  }
};
